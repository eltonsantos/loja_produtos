...
class ProdutosControllerTest < ActionController::TestCase
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post :create, produto: { nome: @produto.nome, preco: @produto.preco, qtd_estoque: @produto.qtd_estoque }
    end
  ...
  test "should update produto" do
    patch :update, id: @produto, produto: { nome: @produto.nome, preco: @produto.preco, qtd_estoque: @produto.qtd_estoque }
    assert_redirected_to produto_path(assigns(:produto))
  end
